...
(function() {
  var INITIAL_BUFFER_MAX_SIZE, ImageHeaders, METADATA_SECTION_MAX_SIZE, exif;
  ...
  ImageHeaders = (function() {
    ...
    function ImageHeaders() {
      this.finished = false;
      this.buffer = new Buffer(INITIAL_BUFFER_MAX_SIZE);
    ...
    ImageHeaders.prototype.add_bytes = function(bytes) {
      ...
      if (this.buffer_index >= INITIAL_BUFFER_MAX_SIZE) {
        this.finished = true;
        return;
      }
